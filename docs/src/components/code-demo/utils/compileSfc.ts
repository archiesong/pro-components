...
async function ensureDependencies() {
  ...
  if (!modulesReady) {
    const [icons, antdv, dayjs, proComponents, proCard, proForm, proField, proLayout, proListy, proProvider, proTable, proUtils, routeUtils] = await Promise.all([
      import('@antdv-next/icons'),
      import('antdv-next'),
      import('dayjs'),
      import('@antdv-next1/pro-card'),
      import('@antdv-next1/pro-field'),
      import('@antdv-next1/pro-form'),
      import('@antdv-next1/pro-layout'),
      import('@antdv-next1/pro-listy'),
      import('@antdv-next1/pro-provider'),
      import('@antdv-next1/pro-table'),
      import('@antdv-next1/pro-utils'),
      import('@antdv-next1/route-utils'),
      import('@antdv-next1/pro-components'),
    ])
    modulesMap['@antdv-next/icons'] = icons
    modulesMap['antdv-next'] = antdv
    modulesMap['@antdv-next1/pro-card'] = proCard
    modulesMap['@antdv-next1/pro-field'] = proField
    modulesMap['@antdv-next1/pro-form'] = proForm
    modulesMap['@antdv-next1/pro-layout'] = proLayout
    modulesMap['@antdv-next1/pro-listy'] = proListy
    modulesMap['@antdv-next1/pro-provider'] = proProvider
    modulesMap['@antdv-next1/pro-table'] = proTable
    modulesMap['@antdv-next1/pro-utils'] = proUtils
    modulesMap['@antdv-next1/route-utils'] = routeUtils
    modulesMap['@antdv-next1/pro-components'] = proComponents
