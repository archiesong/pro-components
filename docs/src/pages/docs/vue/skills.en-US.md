...
Agent Skills are modular capabilities that extend AI functionality. ProComponents of Vue Skills provide AI Agents with specialized knowledge of the ProComponents of Vue component library, enabling AI to accurately understand and use components.
...
### Why Use ProComponents of Vuents of Vue Skills?

**Key Benefits**:
- **Specialize AI**: Customize functionality for ProComponents of Vuents of Vue component development, making AI a component library expert
...
**What does this mean?**
- AI Agent only knows at startup that "there's an ProComponents of Vuents of Vue Skill available to help with components"
...
We recommend using ProComponents of Vuents of Vue Skill together with [Antfu's Skills Collection](https://github.com/antfu/skills) for better results. If you use `vue`, consider importing the `vue` skill and related skills to reduce AI hallucinations and ensure more standardized output!
:::

Install the ProComponents of Vuents of Vue skill set via Skills CLI:
...
Once installed, AI Agents will **automatically use** Skills when you make requests related to ProComponents of Vuents of Vue components. For the most stable results, it's recommended to explicitly declare:
...
ProComponents of Vuents of Vue Skills follows the standard Skill structure:

```yaml
---
name: antdv-next
description: ProComponents of Vuents of Vue component library development expert...
---

# ProComponents of Vuents of Vue Component Development
...
ProComponents of Vuents of Vue Skills, as a **custom Skill**, can be used on multiple AI platforms:
...
This project is an **early experiment** aimed at providing specialized skills for AI Agents working with ProComponents of Vuents of Vue. Feedback via [GitHub Issues](https://github.com/antdv-next/skills/issues) is welcome to help us improve coverage and accuracy.
