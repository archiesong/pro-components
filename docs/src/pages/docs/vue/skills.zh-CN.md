...
Agent Skills 是扩展 AI 功能的模块化能力。ProComponents of Vue Skills 为 AI Agent 提供 ProComponents of Vue 组件库的专业知识，让 AI 能够准确理解和使用组件。
...
### 为什么使用 ProComponents of Vuents of Vue Skills？

**主要优势**：
- **专业化 AI**：为 ProComponents of Vuents of Vue 组件开发定制功能，让 AI 成为组件库专家
...
**这意味着什么？**
- AI Agent 启动时只知道「有一个 ProComponents of Vuents of Vue Skill 可以帮助处理组件」
...
我们建议不要单独食用 ProComponents of Vuents of Vue Skill 配合 [Antfu Skills 集合](https://github.com/antfu/skills) 来使用更佳，如果你使用 `vue` 可以将 `vue` 的skill以及相关的 `skills` 全都导入以减少 `AI` 幻觉，让他的输出更为标准！

:::

通过 Skills CLI 安装 ProComponents of Vuents of Vue 技能集：
...
安装后，AI Agent 会在与 ProComponents of Vuents of Vue 组件相关的请求中**自动使用** Skills。为了获得最稳定的效果，建议在提示词前显式声明：
...
ProComponents of Vuents of Vue Skills 遵循标准 Skill 结构：

```yaml
---
name: antdv-next
description: ProComponents of Vuents of Vue 组件库开发专家...
---

# ProComponents of Vuents of Vue 组件开发
...
ProComponents of Vuents of Vue Skills 作为**自定义 Skills** 可在多个 AI 平台使用：
...
该项目是一个**早期实验**，旨在为 AI Agent 提供面向 ProComponents of Vuents of Vue 的专用技能。欢迎通过 [GitHub Issues](https://github.com/antdv-next/skills/issues) 提供反馈，帮助我们提升覆盖范围与准确性。
