...
这是一个最简单的 ProComponents of Vuents of Vue 组件的在线 stackblitz 演示。
...
访问 [ProComponents of Vuents of Vue Start Template](https://stackblitz.com/edit/vitejs-vite-stk21cho?file=src%2FApp.vue) 创建一个 stackblitz 的在线示例，别忘了保存以创建一个新的实例。
