...
import { ProFormCascader, ProFormCheckboxGroup, ProFormDatePicker, ProFormDateRangePicker, ProFormDateTimePicker, ProFormDateTimeRangePicker, ProFormDigit, ProFormFieldSet, ProFormSelect, ProFormSlider, ProFormSwitch, ProFormText, ProFormTimePicker, ProFormTreeSelect, ProLightFilter } from '@antdv-next/pro-form'
...
const variant
  = shallowRef<LightFilterVariant>('filled')
...
const model = reactive<Partial<FilterFormValues>>({
  keyword: '关键词示例',
  sex: [
    { value: 'man', label: '男' },
  ],
  ...
  <div class="m-b-4">
    ...
    <div style="margin-bottom: 16px;">
      <Space>
        ...
        >
          ...
          <RadioButton value="outlined">
            线框 (outlined)
          </RadioButton>
          <RadioButton value="filled">
            填充 (filled)
          </RadioButton>
          <RadioButton value="underlined">
            下划线 (underlined)
          </RadioButton>
        </RadioGroup>
      </Space>
    ...
    >
      ...
      <ProFormText
        ...
        placeholder="请输入地址"
      />
      <ProFormDatePicker name="date" label="日期" :allow-clear="false" />
