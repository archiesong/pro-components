  ...
  <div class="p-6">
    ...
    >
      <ProFormGroup title="Text Types">
        ...
        <ProFormPassword width="md" name="password" label="Password" />
      </ProFormGroup>
      <ProFormGroup
      ...
      >
        ...
        <ProFormSelect
          ...
          ]" name="useMode" label="Contract Agreed Effective Method"
        />
        <ProFormSelect
          name="select-multiple" label="Select[multiple]" :value-enum="{
            red: 'Red',
            green: 'Green',
            blue: 'Blue',
          }" :field-props="{
            mode: 'multiple',
          }" placeholder="Please select favorite colors" :rules="[
            {
              required: true,
        ...
        />
        <ProFormTreeSelect
          name="treeSelect" label="TreeSelect Request" placeholder="Please tree select" allow-clear
          :width="330" secondary :request="async () => {
            return [
              {
                title: 'Node1',
                value: '0-0',
        ...
        />
        <ProFormRadioGroup
          name="radio" label="Radio.Group" :options="[
            {
              label: 'item 1',
              value: 'a',
            },
        ...
        />
        <ProFormRadioGroup
          name="radio-vertical" layout="vertical" label="Radio.Group" :options="[
            {
              label: 'item 1',
              value: 'a',
            },
        ...
        />
        <ProFormRadioGroup
          name="radio-button" label="Radio.Button" radio-type="button" :options="[
            {
              label: 'item 1',
              value: 'a',
            },
      ...
      <ProFormGroup title="Number Types">
        <ProFormDigitRange
          label="InputNumberRange" name="input-number-range" separator="-"
          :placeholder="['Min', 'Max']" :separator-width="60"
        />
        <ProFormDigit label="InputNumber" name="input-number" width="sm" :min="1" :max="10" />
        <ProFormSwitch name="switch" label="Switch" />
        <ProFormSlider
          name="slider" label="Slider" width="lg" :marks="{
            0: 'A',
            20: 'B',
            40: 'C',
            60: 'D',
        ...
        <ProFormSegmented
          name="segmented" label="Segmented Control" :value-enum="{
            open: 'Unresolved',
            closed: 'Resolved',
          }"
        />
        <ProFormSegmented
          name="segmented2" label="Segmented Control - Remote Data" :request="async () => [
            { label: 'All', value: 'all' },
            { label: 'Unresolved', value: 'open' },
            { label: 'Resolved', value: 'closed' },
            { label: 'In Progress', value: 'processing' },
