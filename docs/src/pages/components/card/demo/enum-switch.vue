...
const size = ref<'medium' | 'small'>('medium')
const variant = ref<'outlined' | 'borderless'>('outlined')
const layout = ref<'default' | 'center'>('default')
const type = ref<'default' | 'inner'>('default')
