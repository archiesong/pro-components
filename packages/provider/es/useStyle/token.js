import { cssinjs as d, theme as i } from "ant-design-vue";
const { createTheme: b } = d, c = {
  blue: "#1677ff",
  purple: "#722ED1",
  cyan: "#13C2C2",
  green: "#52C41A",
  ...
  let e = 3735928559 ^ l, o = 1103547991 ^ l;
  for (let f = 0, n; f < r.length; f++)
    n = r.charCodeAt(f), e = Math.imul(e ^ n, 2654435761), o = Math.imul(o ^ n, 1597334677);
  return e = Math.imul(e ^ e >>> 16, 2246822507) ^ Math.imul(o ^ o >>> 13, 3266489909), o = Math.imul(o ^ o >>> 16, 2246822507) ^ Math.imul(e ^ e >>> 13, 3266489909), 4294967296 * (2097151 & o) + (e >>> 0);
}, x = b((r) => r);
var a, t, g;
const s = {
  theme: x,
  token: {
    ...c,
    ...(g = (a = i) == null ? void 0 : a.defaultAlgorithm) == null ? void 0 : g.call(a, (t = i) == null ? void 0 : t.defaultSeed)
  },
  hashId: `pro-${p(JSON.stringify(c))}`
}, m = () => s;
export {
  c as defaultToken,
  x as emptyTheme,
