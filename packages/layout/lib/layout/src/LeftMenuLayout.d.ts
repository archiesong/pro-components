declare const LeftMenuLayout: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    avatarProps: {
        type: import('vue').PropType<false | (Partial<import('vue').ExtractPropTypes<{
            ...
            render?: (avatarProps: import('ant-design-vue').AvatarProps, defaultDom: import('ant-design-vue/lib/_util/type').VueNode, props: import('./components/SiderMenu/SiderMenu').SiderMenuProps) => import('ant-design-vue/lib/_util/type').VueNode;
        })>;
        default: undefined;
    };
    actionsRender: {
