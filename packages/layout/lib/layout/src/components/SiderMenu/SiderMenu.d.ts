...
export declare const siderMenuProps: () => {
    ...
    onOpenChange: {
        type: PropType<(openKeys?: WithFalse<import('ant-design-vue/lib/_util/type').Key[]>) => void>;
        default: undefined;
    };
    location: {
        type: PropType<{
    ...
    openKeys: {
        type: PropType<WithFalse<import('ant-design-vue/lib/_util/type').Key[]>>;
        default: undefined;
    };
    mode: {
...
declare const SiderMenu: import('vue').DefineComponent<ExtractPropTypes<{
    ...
    onOpenChange: (openKeys?: WithFalse<import('ant-design-vue/lib/_util/type').Key[]>) => void;
    ...
    openKeys: WithFalse<import('ant-design-vue/lib/_util/type').Key[]>;
    selectable: boolean;
    inlineIndent: number;
