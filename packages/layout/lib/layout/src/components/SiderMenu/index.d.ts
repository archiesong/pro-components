...
export declare const siderMenuWrapperProps: () => {
    ...
    logo: {
        type: PropType<import('ant-design-vue/lib/_util/type').VueNode>;
        default: undefined;
    };
    ...
    avatarProps: {
        type: PropType<false | (Partial<import('vue').ExtractPropTypes<{
            ...
            render?: (avatarProps: import('ant-design-vue').AvatarProps, defaultDom: import('ant-design-vue/lib/_util/type').VueNode, props: import('./SiderMenu').SiderMenuProps) => import('ant-design-vue/lib/_util/type').VueNode;
        })>;
        default: undefined;
    };
    actionsRender: {
