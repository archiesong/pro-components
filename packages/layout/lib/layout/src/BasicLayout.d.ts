...
declare const BasicLayout: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    compact: {
        type: import('vue').PropType<import('./defaultSettings').PureSettings["compact"]>;
        default: undefined;
    };
    routes: {
        type: import('vue').PropType<MenuDataItem[]>;
        default: undefined;
    };
    location: {
    ...
    itemClick: import('vue').PropType<(item: import('./components/AppsLogoComponents/typing').AppItemProps, popoverRef: Ref<HTMLSpanElement | null>) => void>;
    links: {
    ...
    menuData: import('vue').PropType<MenuDataItem[]>;
    ...
    postMenuData: {
        type: import('vue').PropType<(menusData?: MenuDataItem[]) => MenuDataItem[]>;
        default: undefined;
    };
    ...
    links: import('./typing').WithFalse<VueNode[] | {
        icon?: import('vue').VNode;
        title?: string;
        label?: import('vue').VNode;
    }[]>;
    ...
    }>>, "itemRender"> & import('./proLayoutProps').LayoutBreadcrumbProps<import('ant-design-vue/lib/_util/type').AnyObject>;
    ...
    waterMarkProps: Partial<import('vue').ExtractPropTypes<{
        ...
        font: {
            type: import('vue').PropType<import('ant-design-vue/lib/watermark').WatermarkFontType>;
            default: import('ant-design-vue/lib/watermark').WatermarkFontType;
        };
