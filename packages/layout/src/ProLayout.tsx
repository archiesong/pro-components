...
import type { CustomSlotsType, MenuDataItem, MessageDescriptor, RouterTypes, VueNode, WithFalse } from './typing'
...
export interface ProLayoutProps extends GlobalTypes {
  class?: string
  style?: CSSProperties
  stylish?: {
