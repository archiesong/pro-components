import { useStyle as e } from "@ant-design-vue/pro-provider";
const n = (o) => ({
  [`${o.componentCls}-handle`]: {
    position: "absolute",
    insetBlockStart: 240,
    insetInlineEnd: 300,
    zIndex: 0,
    ...
    borderEndStartRadius: o.borderRadiusLG,
    borderStartStartRadius: o.borderRadiusLG,
  ...
  [o.componentCls]: {
    "&-collapsed": {
      [`${o.antCls}-drawer-content-wrapper`]: {
        display: "block !important",
        transform: "translateX(100%) !important"
      }
    },
    "&-realDark": {
      [`${o.componentCls}-body-title`]: {
        color: "rgb(229, 224, 216)"
      },
      [`${o.componentCls}-content`]: {
        [`${o.componentCls}-block-checkbox`]: {
          "&-item": {
            "&-realDark": {
...
function l(o) {
  return e("ProLayoutSettingDrawer", (r) => {
    const t = {
      ...r,
