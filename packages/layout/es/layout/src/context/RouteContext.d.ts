...
export declare const useRouteContextInject: () => Ref<{
    breadcrumb?: {
        ...
        itemRender?: ((opt: {
            ...
            paths: string[];
        }) => import('ant-design-vue/es/_util/type').VueNode) | undefined;
    } | undefined;
    menuData?: {
        [x: string]: any;
    ...
    breadcrumbProps?: {
        ...
        itemRender?: ((opt: {
            route: import('ant-design-vue/es/breadcrumb/Breadcrumb').Route;
            params: import('ant-design-vue/es/_util/type').AnyObject;
            routes: import('ant-design-vue/es/breadcrumb/Breadcrumb').Route[];
            paths: import('ant-design-vue/es/breadcrumb/Breadcrumb').Route[];
        }) => import('ant-design-vue/es/_util/type').VueNode) | undefined;
    } | undefined;
    waterMarkProps?: {
