declare const TableRender: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    ...
    request: {
        type: import('vue').PropType<(params: Record<string, any> & {
            ...
            current?: number;
            keyword?: string;
        }, sort: Record<string, import('ant-design-vue/es/table/interface').SortOrder>, filter: Record<string, (string | number)[] | null>) => Promise<Partial<import('./typing').RequestData<any>>>>;
        default: undefined;
    };
    editable: {
