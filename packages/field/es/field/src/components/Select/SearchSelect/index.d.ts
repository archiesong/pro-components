...
export declare const searchSelectProps: () => {
    ...
    onSelect: import('vue').PropType<import('ant-design-vue/es/vc-select/Select').SelectHandler<(string | number) | LabeledValue, import('ant-design-vue/es/select').DefaultOptionType>>;
    ...
    onDeselect: import('vue').PropType<import('ant-design-vue/es/vc-select/Select').SelectHandler<(string | number) | LabeledValue, import('ant-design-vue/es/select').DefaultOptionType>>;
