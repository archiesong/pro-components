...
declare const FieldSelect: import('vue').DefineComponent<ExtractPropTypes<{
    ...
    label: import('ant-design-vue/es/_util/type').VueNode;
    valueEnum: ProFieldValueEnumType;
    customRender: ((text: any, props: Omit<import('@ant-design-vue/pro-provider').ProFieldFCRenderProps, "value" | "onChange">, dom: import('ant-design-vue/es/_util/type').VueNode) => import('ant-design-vue/es/_util/type').VueNode) | undefined;
    renderFormItem: ((text: any, props: import('@ant-design-vue/pro-provider').ProFieldFCRenderProps, dom: import('ant-design-vue/es/_util/type').VueNode) => import('ant-design-vue/es/_util/type').VueNode) | undefined;
