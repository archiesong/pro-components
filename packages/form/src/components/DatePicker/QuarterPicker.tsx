...
export type ProFormDateQuarterPickerProps = ProFormFieldItemProps<DatePickerProps>

const ProFormDateQuarterPicker = defineComponent<ProFormDateQuarterPickerProps, {}, string, CustomSlotsType<{
  default?: () => VueNode
}>>((props, { slots, attrs }) => {
  ...
  name: 'ProFormDateQuarterPicker',
  inheritAttrs: false,
})
export default ProFormDateQuarterPicker
