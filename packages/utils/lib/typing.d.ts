import { CSSProperties, VNode, Ref } from 'vue';
import { AvatarProps, CascaderProps, CheckboxProps, DatePickerProps, DividerProps, ImageProps, InputNumberProps, InputProps, ProgressProps, RadioProps, RateProps, SegmentedProps, SelectProps, SpaceProps, SwitchProps, TextAreaProps, TimeRangePickerProps, TooltipProps, TreeSelectProps } from 'ant-design-vue';
import { UseEditableUtilType } from './useEditableArray';
import { FormItemProps, FormInstance } from 'ant-design-vue/lib/form';
import { RangePickerProps } from 'ant-design-vue/lib/date-picker';
import { Key, VueNode } from 'ant-design-vue/lib/_util/type';
import { ProSchemaValueEnumType } from '@ant-design-vue/pro-provider';
 ...
 */
type FieldPropsTypeBase<Entity = Record<string, any>, ComponentsType = 'text', ExtraProps = Record<string, any>, FieldPropsType = ProFieldValueTypeWithFieldProps['text']> = ((form: FormInstance, config: ProSchema<Entity, ExtraProps> & {
    type: ComponentsType;
    isEditable?: boolean;
    rowKey?: string;
    rowIndex: number;
...
export type ProSchema<Entity = Record<string, any>, ExtraProps = unknown, ComponentsType extends ProSchemaComponentTypes = 'form', ValueType = 'text', ExtraFormItemProps = unknown> = {
     ...
     * @name 标题
     */
    title?: ((schema: ProSchema<Entity, ExtraProps, ComponentsType, ValueType, ExtraFormItemProps>, type: ComponentsType, dom: VueNode) => VueNode) | VueNode;
     ...
     */
    formItemProps?: (FormItemProps & ExtraFormItemProps) | ((form: FormInstance, config: ProSchema<Entity, ExtraProps, ComponentsType, ValueType, ExtraFormItemProps> & {
        type: ComponentsType;
        isEditable?: boolean;
        rowKey?: string;
        rowIndex: number;
    ...
    }, action?: ProCoreActionType) => VueNode | {
        children: VueNode;
        props: any;
    };
    /**
    ...
    }, form: FormInstance, action?: Omit<UseEditableUtilType, 'newLineRecord' | 'editableKeys' | 'actionRender' | 'setEditableRowKeys'>) => VueNode;
    /**
     *  @name 可编辑表格是否可编辑
     *
     * @example 不允许编辑
