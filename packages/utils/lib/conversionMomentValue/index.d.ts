...
import { ProFieldValueType } from '../typing';
import { default as dayjs } from 'dayjs';
type DateFormatter = (string & Record<string, any>) | 'number' | 'string' | ((value: dayjs.Dayjs, valueType: string) => string | number) | false;
 ...
 */
declare const conversionMomentValue: <T extends Record<string, any> = any>(value: T, dateFormatter: DateFormatter, valueTypeMap: Record<string, {
