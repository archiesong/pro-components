...
function copy(text: string, options?: Options): boolean {
  ...
  try {
    ...
    mark.style.setProperty('MozUserSelect', 'text')
    // mark.style.MozUserSelect = 'text'
    mark.style.setProperty('msUserSelect', 'text')
    ...
    mark.addEventListener('copy', (e) => {
      ...
      if (options.format) {
        ...
        if (typeof e.clipboardData === 'undefined') {
          ...
          const format = clipboardToIE11Formatting[options.format as keyof typeof clipboardToIE11Formatting] || clipboardToIE11Formatting.default
