...
export declare const proFormContextKey: InjectionKey<ProFormInstanceType<any> & {
    formRef?: Ref<FormInstance>;
}>;
export declare const useProFormContextProvider: (props: ProFormInstanceType<any> & {
    formRef?: Ref<FormInstance>;
}) => void;
export declare const useProFormContextInject: () => ProFormInstanceType<any> & {
    formRef?: Ref<FormInstance>;
};
